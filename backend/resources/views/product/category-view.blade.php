        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Kategori: {{ $category->name_category }}</h1>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <h5 class="mb-0">Produk dalam Kategori {{ $category->name_category }}</h5>
                        </div>
                        <div class="card-body">
                            @if($products->count())
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Edit button with data attributes for the product -->
                                            ...
                                            <!-- Delete button with data-id for deletion -->
