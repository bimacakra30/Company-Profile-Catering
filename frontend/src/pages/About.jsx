export default function About() {
  return (
    <section className="relative text-center mb-20 pt-24 px-4">
      {/* Title Section */}
      ...
      <div className="max-w-5xl mx-auto mt-16">
        {/* Story Section */}
        <div className="text-gray-700 space-y-6 text-base leading-relaxed mb-14">
          ...
          <p className="italic text-[#434f2a] font-medium text-center px-4">
        ...
        {/* Legal & Trust Section */}
        <div className="bg-gradient-to-r from-[#f7f3e8] to-white rounded-2xl p-6 md:p-10 mb-14 shadow-md border border-[#434f2a]/10">
          <div className="text-center mb-6">
            <div className="inline-block px-4 py-1.5 bg-[#205e2e] text-white rounded-full text-xs font-medium mb-3 shadow">
              🔐 Kepercayaan & Legalitas
            </div>
            <h3 className="text-2xl font-bold text-[#434f2a] mb-3">Usaha Kami Telah Memiliki Izin Resmi</h3>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {/* Card 1 */}
            <div className="group bg-white rounded-xl shadow-md hover:shadow-lg p-5 text-center transition-all duration-300 hover:-translate-y-2 border-l-4 border-[#205e2e]">
              <div className="w-14 h-14 bg-gradient-to-br from-[#205e2e] to-[#434f2a] rounded-full flex items-center justify-center mx-auto mb-3 transform group-hover:scale-110 shadow">
            ...
            {/* Card 2 */}
            <div className="group bg-white rounded-xl shadow-md hover:shadow-lg p-5 text-center transition-all duration-300 hover:-translate-y-2 border-l-4 border-[#434f2a]">
              <div className="w-14 h-14 bg-gradient-to-br from-[#434f2a] to-[#205e2e] rounded-full flex items-center justify-center mx-auto mb-3 transform group-hover:scale-110 shadow">
                <span className="text-xl">🍴</span>
              </div>
        ...
        <div className="max-w-6xl mx-auto mb-14">
          <div className="text-center mb-10">
            <div className="inline-block px-3 py-1 bg-[#f7f3e8] text-[#434f2a] rounded-full text-xs font-semibold mb-3">
              ⭐ Keunggulan Kami
            </div>
            <h3 className="text-2xl font-bold text-[#434f2a] mb-3">Mengapa Memilih Dandanggulo?</h3>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            {[
              ...
              <div key={idx} className="group bg-white rounded-2xl shadow-md hover:shadow-lg p-6 text-center transition-all duration-300 hover:-translate-y-2 border-b-4 border-[#205e2e]">
        ...
        <div className="text-center mb-14">
          <div className="bg-gradient-to-r from-[#434f2a] to-[#205e2e] rounded-2xl p-6 md:p-10 text-white shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="mb-4">
                <span className="inline-block px-5 py-1.5 bg-[#f7f3e8] text-[#434f2a] rounded-full text-xs font-medium">
                  💝 Komitmen Kami
                </span>
              </div>
              <h3 className="text-xl md:text-2xl font-bold mb-3 text-[#f7f3e8]">Kami Siap Menyajikan yang Terbaik</h3>
              <p className="text-base md:text-lg font-medium leading-relaxed text-[#f7f3e8] mb-3">
