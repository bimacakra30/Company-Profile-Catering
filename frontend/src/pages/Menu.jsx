    ...
    <div className="min-h-screen" style={{ backgroundColor: '#f8f5f0' }}>
      ...
      <div className="pt-32 pb-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{ color: '#4a5d3a' }}>
            Menu {titleCase(slug)}
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Nikmati koleksi menu {titleCase(slug).toLowerCase()} terbaik dari Dandanggulo Catering. 
            Setiap hidangan dibuat dengan bahan berkualitas tinggi dan cita rasa yang tak terlupakan.
          </p>
          ...
          <>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-3">
                      <button 
                        className="flex-1 py-2.5 px-4 text-white rounded-lg font-medium transition-all duration-300 hover:opacity-90 hover:scale-105"
                        style={{ backgroundColor: '#5d7c47' }}
                      >
                        Pesan Sekarang
                      </button>
            ...
            <div className="bg-white rounded-xl shadow-md p-8 mt-16 text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                ...
                Tim berpengalaman kami siap membantu mewujudkan acara yang berkesan.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 text-white rounded-lg font-medium transition-all duration-300 hover:opacity-90 hover:scale-105"
                  style={{ backgroundColor: '#5d7c47' }}
                >
                ...
                <a 
                  href="/kontak" 
                  className="inline-flex items-center justify-center px-6 py-3 border-2 rounded-lg font-medium transition-all duration-300 hover:bg-opacity-10"
                  style={{ 
                    borderColor: '#5d7c47', 
                    color: '#5d7c47'
                  }}
